class Edit extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if (this.state.username.length < 3) {
      ...
      accountToast.getElementsByClassName("toast-body")[0].innerHTML =
        "Enter a name above 3 characters.";
      toast.show();
      return;
    }
    ...
    if (this.state.bio.length > 150) {
      ...
      accountToast.getElementsByClassName("toast-body")[0].innerHTML =
        "Your bio must be 150 characters or less.";
      toast.show();
      return;
    }
  ...
  render() {
    return (
      <div className="col-12 border col-sm-9">
        <div className="row mx-auto mt-4 settings-content">
          ...
          <div className="mb-3 col">
            ...
            <a
              ...
              data-bs-target="#modalProfilePicture"
            >
        ...
        <form
          className="row mx-auto mt-1 settings-content"
          method="post"
          id="updateProfile"
...
class ChangePassword extends React.Component {
  ...
  componentDidUpdate() {
    if (
      ...
      document
        .getElementById("btn-changePassword")
  ...
  render() {
    return (
      <div className="col-12 col-sm-9 border">
        <form
          className="row mx-auto mt-4 settings-content"
          onSubmit={this.handleSubmit}
          id="change-password"
        >
...
class Accounts extends React.Component {
  ...
  render() {
    const loadImage = this.state.load ? (
      <div
        className="rounded-circle text-center position-absolute top-0"
        id="img-loading"
        style={{
          width: 50,
          height: 50,
      ...
      <div className="container">
        ...
        <div className="container bg-white px-0 border-rounded my-4 mx-auto justify-content-evenly d-block d-sm-flex">
          <ul className="list-group rounded-0 pe-0 col-sm-3 col-12 border border-end-0 settings-menu align-items-center align-items-sm-start text-center justify-content-between justify-content-sm-start">
            <a
              href={this.props.link + "edit"}
              className={
                "list-group-item py-sm-3 py-2 px-1 px-sm-4" +
                (this.state.active === "edit" ? " list-active" : "")
              }
            ...
            <a
              href={this.props.link + "password."}
              className={
                "list-group-item py-md-3 py-2 px-md-4 px-0" +
                (this.state.active === "password/change" ? " list-active" : "")
              }
              onClick={this.navigation}
              data-nav="password/change"
            >
              Change Password
            </a>
            <a
              className="list-group-item py-sm-3 py-2 px-sm-4 px-1 color-red logout"
              role="button"
              onClick={this.logout}
            >
              Logout
...
function ModalEdit(props) {
  return (
    <div
      ...
      tabIndex="-1"
      aria-labelledby="modalProfilePictureLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog modal-dialog-centered modal-sm">
        <div className="modal-content border-rounded overflow-hidden">
          <div className="modal-header justify-content-center">
            <h5 className="modal-title fw-bold" id="modalProfilePictureLabel">
              Change profile photo
            </h5>
          </div>
            ...
            <ul className="list-group text-center">
              ...
              >
                <label
                  ...
                  className="list-group-item color-blue"
                  role="button"
                >
                  Upload Photo
                </label>
              ...
              <li
                className="list-group-item text-danger border-top"
                role="button"
              >
...
ReactDOM.render(
  <div>
    ...
    <div
      id="accountToast"
      className="toast align-items-center text-white bg-black border-0 position-absolute bottom-0 w-100 rounded-0"
      role="alert"
      aria-live="assertive"
      aria-atomic="true"
    >

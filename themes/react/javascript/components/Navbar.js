  ...
  userItem() {
    ...
    return (
      <li className="nav-item dropdown">
        ...
        <ul
          className="dropdown-menu nav-dropdown shadow-sm"
          aria-labelledby="navbarDropdown"
        >
          <li>
            <a className="dropdown-item" href={window.User.Name}>
              <i className="bi bi-person-circle me-2"></i>Profile
            </a>
          </li>
          <li>
            <a className="dropdown-item" href="accounts/edit">
      ...
      return (
        <div className="container">
          <a className="navbar-brand d-flex align-items-center" href="">
            <img
              src="public/_resources/themes/react/images/rocket.png"
              alt="logo_rocket"
              width="40px"
            />

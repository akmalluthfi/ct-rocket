class Post extends React.Component {
    ...
    renderPost(post) {
        return (
            <div key={post.Id} className="col-4 p-1 p-md-3 btn-detailsModal" role="button" data-bs-toggle="modal" data-bs-target="#detailsModal" data-id={post.Id} onClick={this.handleClick}>
                <div className="ratio ratio-1x1">
                    <div className="overflow-hidden bg-img shadow border-rounded">
                        <div className="bg-post w-100 h-100 bg-center"
                            style={{ backgroundImage: 'url("' + post.Images[0].Link + '")' }}>
                            <div className="d-flex justify-content-center align-items-center h-100">
                                <button type="button" className="btn btn-outline-grey btn-sm font-12">Details</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    render() {
        ...
        const noPost = (
            <div>
                <div className="mx-auto border border-3 rounded-circle border-dark d-flex justify-content-center align-items-center mt-5"
